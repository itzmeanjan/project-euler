...
func main() {
	...
	/*
		...
		start = time.Now()
		fmt.Printf("\n\tProblem 41 : %d in %v\n", projecteuler.PandigitalPrime(), time.Now().Sub(start))
		start = time.Now()
		fmt.Printf("\n\tProblem 42 : %d in %v\n", projecteuler.CodedTriangleNumber(), time.Now().Sub(start))
		start = time.Now()
		...
		start = time.Now()
		fmt.Printf("\n\tProblem 49 : %d in %v\n", projecteuler.PrimePermutations(), time.Now().Sub(start))
		start = time.Now()
		...
		start = time.Now()
		fmt.Printf("\n\tProblem 57 : %d in %v\n", projecteuler.SquareRootConvergents(), time.Now().Sub(start))
	*/
